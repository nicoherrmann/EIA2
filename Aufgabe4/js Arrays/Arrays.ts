...
namespace WBKonfig {
       ...
       export let candle: Product[] = [{ name: "Rot | breit [12Euro]", price: 12 }, { name: "Rot | duenn [8Euro]", price: 8 }, { name: "Gold | breit [15Euro]", price: 15 }, { name: "Gold | duenn [10Euro]", price: 10 }, { name: "Silber | breit [20Euro]", price: 20 }, { name: "Silber | duenn [17Euro]", price: 17 }, { name: "Weiﬂ [25Euro]", price: 25 }];
